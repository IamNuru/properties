...
import {
  createUserWithEmailAndPassword, GoogleAuthProvider, FacebookAuthProvider, signInWithPopup, signInWithEmailAndPassword, signOut, updateProfile,
  ...
  const resetPassword = (email) => {
    sendPasswordResetEmail(auth, email)
      ...
      .catch((error) => {
        dispatch({
          type: ERRORS,
          payload: `Sorry ${email} Not found in our records`
        })
      });
  };
